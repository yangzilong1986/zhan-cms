...
public class CMIndvAsset1
    extends FormActions {
  private String CLIENTNO=null;
  public static Logger logger = Logger.getLogger("zt.cms.cm.CMIndvAsset1");
  ...
  public int preInsert(SessionContext ctx, DatabaseConnection conn,
                       FormInstance instance, ErrorMessages msgs,
                       EventManager manager, SqlAssistor assistor) {
    String SEQNO = zt.cms.pub.code.SerialNumber.getNextSN("CMINDVASSET","SEQNO")+"";
