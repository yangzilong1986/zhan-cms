...
String CMT1=null;
  ...
  String sql="";
  String query_sql="select *from FCCMT where FCNO='"+FCNO+"' and FCCMTTYPE=8";
  CachedRowSet crs=manager.getRs(query_sql);
  if(crs.next()){
	sql="update FCCMT set cmt1='"+DBUtil.toDB(CMT1)+"' where FCNO='"+FCNO+"' and FCCMTTYPE=8";
  }
  else{
	sql="insert into FCCMT(FCNO,FCCMTTYPE,CMT1) values('"+FCNO+"',8,'"+DBUtil.toDB(CMT1)+"')";
  }
