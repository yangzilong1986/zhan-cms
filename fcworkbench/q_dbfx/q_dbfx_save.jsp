...
String CMT1=null;
  ...
  if(crs.next()){
	sql="update FCCMT set cmt1='"+DBUtil.toDB(CMT1)+"' where FCNO='"+FCNO+"' and FCCMTTYPE=6";
  }
  else{
	sql="insert into FCCMT(FCNO,FCCMTTYPE,CMT1) values('"+FCNO+"',6,'"+DBUtil.toDB(CMT1)+"')";
  }
  ...
  if(temp){
	...
	%>
	<jsp:forward page="/fcworkbench/q_dbfx/q_dbfx.jsp"/>
	<%
  }
  else{
