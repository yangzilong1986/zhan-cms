...
import zt.cmsi.pub.code.BMBaseInst;
...
public class BaseInstPage extends FormActions {
  public static Logger logger = Logger.getLogger("zt.cms.sys.BaseInstPage");
  ...
  public int preInsert(SessionContext ctx, DatabaseConnection conn,
                       FormInstance instance, ErrorMessages msgs,
                       EventManager manager, SqlAssistor assistor) {
    int seqNo = (int) BMBaseInst.getNextNo();
  ...
  public int postInsertOk(SessionContext ctx, DatabaseConnection conn,
    ...
    zt.cmsi.pub.define.BMBaseInst.setDirty();
