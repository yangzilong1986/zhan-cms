...
<form action="q_other_add_save.jsp" name="form1" method="post" id="winform" onsubmit="return Regvalid(this)">
                                    ...
                                    <td>
                                        ...
                                        <table class='page_form_table' width='400' align='center'
                                            ...
                                            <tr class='page_form_tr'>
                                                ...
                                                <td class="page_form_td"><textarea name="CMT1" wrap="PHYSICAL" cols="40"
                                                                                   rows="3"
