            ...
            <table height="325" border="2" align="center" cellpadding="2" cellspacing="2" bordercolor="#816A82"
                ...
                <tr align="left">
                    <td height="30" bgcolor="#A4AEB5">
                        <img src="../images/form/formtile1.gif" align="absmiddle" height="22px" width="22px">
                        <font size="2" color="#ccc"><b><%=sp.getHead()%>
                        </b></font>
                    ...
                    <td align="center">
                        <table border="0" cellspacing="0" cellpadding="0" width="538">
                            <tr>
                                ...
                                %>
                                <td nowrap align="left" width="60%"><%=sysButton%>
                                </td>
                                <td nowrap align="left" width="40%">&nbsp;<font size="2"
                                                                                color="#000066"><%=afterSysButton%>
                                </font></td>
                                <%
                                } else {
                                %>
                                <td nowrap align="center"><%=sysButton%>
                                </td>
                                <%
                                    }
