...
<%
String lname = null;
String strbmno = (String)request.getParameter("bmno");
...
if(strbmno == null || confirmed == null)
{
	ret = 100;	
	msg = "未取得业务号等参数信息!";
}
else
{
	...
	////System.out.println("bmno:"+strbmno+"confirmed========="+conf);
	fp = fcmain.createFC(strbmno,conf,lname);
	ret = fp.errorCode;
	if(ret == 1)
		msg = "贷款已经在清分工作台中,请确认是否增加新的清分任务?请稍候...";
	else if(ret == 0)
	{
...
function askyou(p_userid){
	if(confirm("本贷款已经在清分工作台中,请确认是否增加新的清分任务?")){
		document.all("form1").action="/fcworkbench/createfcmain.jsp?confirmed=1&bmno=<%=strbmno%>";
			    ...
			    <td valign="top">
					<table width="100%">
						<tr height="70" bgcolor="#4477AA">
							<td background="../images/showinfo.jpg" valign="bottom"><b><font size="2">&nbsp;贷款清分确认信息</font></b></td>
						</tr>
					</table>
