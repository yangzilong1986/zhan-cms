...
public class XFContractPrint extends FormActions {
...
//                    instance.setValue("APPSTATUS", dt.status.split("-")[0]);
...
//                        sqlWhereUtil.addWhereField(fb.getTbl(), "LIMITCONDITION", dt.limitcondition,
...
//            }
//        } else if (button != null && button.equals("DOCONTRACTLINK")) {
//                   trigger(manager, "XFCONTRACTLINK", null);
//
