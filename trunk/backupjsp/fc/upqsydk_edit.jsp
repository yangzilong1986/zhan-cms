...
<jsp:useBean id="form1" scope="page" class="zt.cmsi.fc.form.FormQsydk"  />
...
form1.setFcno(fcno);
boolean ret=fc.updateQsydk(form1);
response.sendRedirect("upqsydk_detail.jsp?fcno="+form1.getFcno()+"&flag="+ret);
%>
