...
<form name="form1" method='post' action="fl_info3.jsp">
...
<a href="#" onClick="return refselect_FCCLASS(opener.winform.CMT4,'<%=DBUtil.fromDB(crs.getString("REASON"))%>')"><%=level.getEnumItemName("LoanCat1",crs.getString("FCCLASS"))%></a>
</td>
<td class='reference_button_tbl_td'>
<a href="#" onClick="return refselect_FCCLASS(opener.winform.CMT4,'<%=DBUtil.fromDB(crs.getString("REASON"))%>')"><%=DBUtil.fromDB(crs.getString("REASON"))%></a>
</td>
 </tr>
 <%
}
...
<script language="javascript">
    		createFlipPage(<%=pn%>,<%=ps%>,<%=rows%>,"fl_info3.jsp?pn=","form1");
</script>
<td>
