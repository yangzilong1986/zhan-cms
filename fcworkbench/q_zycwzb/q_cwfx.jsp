...
<%
    ...
    String CMT1 = "";
//String CMT2="";
    String sql = "select * from FCCMT where FCNO='" + FCNO + "' and FCCMTTYPE=10";
...
<form action="q_cwfx_save.jsp" name="form1" method="post" onsubmit="return Regvalid(this)">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table class='page_form_table' width='530' align='center'
                                                    ...
                                                    <tr class='page_form_tr'>
                                                        <td class=
                                                                "page_form_td" width='15%' align="left">财务分析<br>（最多300汉字）
                                                        </td>
