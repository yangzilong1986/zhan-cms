...
<%
    ...
    String sql = "select * from FCMCMT where FCNO='" + FCNO + "' and DT='" + DT + "' and FCCMTTYPE=3";
...
<form action="z_fcwys_info_save.jsp" name="form1" method="post" id="winform">
...
<tr align="left">
    <td height="30" bgcolor="#4477AA"><img src="/images/form/xing1.JPG" align="absmiddle"> <font
            size="2" color="#FFFFFF"><b>非财务因素</b></font> <img src="/images/form/xing1.JPG"
                                                              align="absmiddle"></td>
</tr>
<tr align="center">
                        ...
                        <tr>
                            <td>
                                ...
                                <table class='page_form_table' width='400' align='center'
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class="page_form_td" align="left" nowrap>经营情况是否正常<br>（最多300汉字）
                                        </td>
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>产品市场需求情况<br>（最多300汉字）
                                        </td>
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>借款人还款意愿<br>（最多300汉字）
                                        </td>
                                        <td class="page_form_td" nowrap><textarea
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>税费交纳情况<br>（最多300汉字）
                                        </td>
                                        <td class="page_form_td" nowrap><textarea
                                                name="CMT4" <%=readonly%> wrap="PHYSICAL" cols="55"
                                                rows="3"
