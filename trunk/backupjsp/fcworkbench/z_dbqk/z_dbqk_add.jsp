...
<form action="z_dbqk_add_save.jsp" name="form1" method="post" id="winform">
...
<tr align="left">
    <td height="30" bgcolor="#4477AA"><img src="/images/form/xing1.JPG" align="absmiddle"> <font
            size="2" color="#FFFFFF"><b>担保情况</b></font> <img src="/images/form/xing1.JPG"
                                                             align="absmiddle"></td>
</tr>
<tr align="center">
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <table class='page_form_table' width='400' align='center' cellpadding='0'
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class=
                                                "page_form_td" align="left" nowrap>担保合同是否有效<br>（最多300汉字）
                                        </td>
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>保证人代偿能力<br>（最多300汉字）</td>
                                        <td class="page_form_td" nowrap><textarea name="CMT2" wrap="PHYSICAL" cols="55"
                                                                                  rows="3"
                                                                                  class="page_form_text"></textarea>
                                        </td>
                                    </tr>
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>抵质押物及其价值<br>（最多300汉字）</td>
                                        <td class="page_form_td" nowrap><textarea name="CMT3" wrap="PHYSICAL" cols="55"
                                                                                  rows="3"
                                                                                  class="page_form_text"></textarea>
                                        </td>
                                    </tr>
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>抵质押物的变现能力<br>（最多300汉字）</td>
                                        <td class="page_form_td" nowrap><textarea name="CMT4" wrap="PHYSICAL" cols="55"
                                                                                  rows="3"
                                                                                  class="page_form_text"></textarea>
                                        </td>
                                    </tr>
...
<script language="javascript" type="text/javascript">
    ...
    function user_check() {
        this.opener.location = "/fcworkbench/z_dbqk/z_dbqk.jsp?pn=" + this.opener.document.all.pnstr.value + "" +
                               "&FCNO=<%=FCNO%>" +
                               "&FCSTATUS=<%=FCSTATUS%>";
        this.close();
    }
