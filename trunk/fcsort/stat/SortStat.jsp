...
=============================================== 
Title:五级分类统计
 * @version  $Revision: 1.3 $  $Date: 2007/05/31 03:13:56 $
 * @author   zhengxin
 * <p/>修改：$Author: zhengx $   
=============================================== 
--%>
...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function backStartList()
			{
				...
				var url = currentPath + "SortStat.jsp?QUERYID=" + QUERYID;
				window.location = url;
			}
		</script>
	...
	<body background="/images/checks_02.jpg">
		<form action="<%=currentPath%>SortStat.jsp" name="listfrom">
