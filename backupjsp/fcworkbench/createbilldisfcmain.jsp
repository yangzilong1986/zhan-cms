...
else
{
	...
	fp = fcmain.createBillDisFC(Integer.parseInt(billno),conf,lname);
	ret = fp.errorCode;
	if(ret == 1)
...
function askyou(p_userid){
	if(confirm("本票据已经在清分工作台中,请确认是否增加新的清分任务?")){
		document.all("form1").action="/fcworkbench/createbilldisfcmain.jsp?confirmed=1&billno=<%=billno%>";
			    ...
			    <td valign="top">
					<table width="100%">
						<tr height="70" bgcolor="#4477AA">
							<td background="../images/showinfo.jpg" valign="bottom"><b><font size="2">&nbsp;(转)贴现清分确认信息</font></b></td>
						</tr>
					</table>
