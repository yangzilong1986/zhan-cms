...
String [] DT=request.getParameterValues("DT");
 if(DT==null || DT.length==0){
		response.sendRedirect("z_qtqksm.jsp");
	}
...
for(int i=0;i<DT.length;i++){
	sqls="delete from FCMCMT where DT='"+DT[i]+"' and FCNO='"+FCNO+"' and FCCMTTYPE=9";
...
if(temp==true && flag==0){
%>
	<jsp:forward page="/fcworkbench/z_qtqksm/z_qtqksm.jsp"/>
	<%
}
