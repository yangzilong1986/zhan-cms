 ...
 */
public class QCorpReceivablesList extends FormActions {
    ...
    public int preFind(SessionContext ctx, DatabaseConnection conn, FormInstance instance, ErrorMessages msgs,
        ...
        String value = ClientSum.getClientSum(strClientNO, "CMCORPRECEIVABLES", "AMT", conn);
    ...
    public int buttonEvent(SessionContext ctx, DatabaseConnection conn, FormInstance instance, String button,
        ...
        if (button != null && button.equals(SessionAttributes.REQUEST_EDIT_BUTTON_VALUE)) {
            trigger(manager, "CMREC2", null);
        } else if (button != null && button.equals(SessionAttributes.REQUEST_BUTTON_ADD_NAME)) {
            trigger(manager, "CMREC2", null);
        }
