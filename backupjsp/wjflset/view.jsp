...
<td class="page_form_td" ><input type="text" name="BRHID" value="<%=BRHID==null?"":BRHID%>" class="page_form_text" mayNull="1" dataType="1" errInfo="网点"></td>
</tr>
<tr class='filter_table_tr'>
<td class="page_form_title_td" nowrap>网点全名</td>
<td class="page_form_td" ><input type="text" name="LNAME" value="<%=LNAME==null?"":LNAME%>" class="page_form_text" mayNull="1" dataType="1" errInfo="网点全名"></td>
</tr>
<tr class='filter_table_tr'>
