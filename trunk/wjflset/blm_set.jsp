...
String sql="select * from FCFACTOR ";
...
function info(infoname){
		var url='blm_info.jsp?FCCLASS='+infoname;
		window.open(url,'FI2','height=500,width=600,toolbar=no,scrollbars=yes,resizable=yes');
}
                      ...
                      <td>
                        ...
                        <table class='list_form_table' width='530' align='center' cellpadding='0' cellspacing='1' border='0'>
                            <tr class='list_form_title_tr'>
							 <td   nowrap width="6%" align="center"><input name="f02" type='checkbox' id="f02" onClick="checkSub('f02','form1','elements')" value=""></td>
                              <td width='15%' class='list_form_title_td' nowrap align="center">五级分类 </td>
                              <td width='70%' class='list_form_title_td' nowrap align="center">权重 </td>
...
%>
							...
							<td align='center' nowrap><input name="aa" type='checkbox' id="f020<%=j++%>" value="<%=crs.getString("FCCLASS")%>"></td>
                              ...
                              <td nowrap class='list_form_td' align="left"><%=df.format(crs.getBigDecimal("FACTOR"))%></td>
                              <td nowrap class='list_form_td' align="center"><a class="list_edit_href" href='javascript:info("<%=crs.getString("FCCLASS")%>")' >详细</a></td>
                            </tr>
                            <%
}
                    ...
                    <tr class="list_button_tbl_tr">
                      ...
                      <td class="list_form_button_td"><input type='submit' name='a' class='list_button_active' value=' 刷新 '  onclick="return req();"></td>
						...
						<script language="javascript">
    						createFlipPage(<%=pn%>,<%=ps%>,<%=rows%>,"blm_set.jsp?pn=","form1");
						</script>
...
function req(){
	document.location.replace("/wjflset/blm_set.jsp");
}
</script>
