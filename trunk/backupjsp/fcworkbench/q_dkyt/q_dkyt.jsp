...
Title: 贷款用途
Description: 贷款用途信息。
 * @version   $Revision: 1.4 $  $Date: 2007/05/29 09:34:03 $
 * @author   
 * <p/>修改：$Author: liuj $
===============================================
--%>
...
<%
    ...
    String CMT1 = "";
    String CMT2 = "";
    String sql = "select * from FCCMT where FCNO='" + FCNO + "' and FCCMTTYPE=5";
...
<form action="q_dkyt_save.jsp" name="form1" method="post" onsubmit="return Regvalid(this)">
    ...
    <table height="325" border="2" align="center" cellpadding="2" cellspacing="2" bordercolor="#006699"
        ...
        <tr align="left">
            <td height="30" bgcolor="#4477AA"><img src="/images/form/xing1.JPG" align="absmiddle"> <font
                    size="2" color="#FFFFFF"><b>贷款用途</b></font> <img src="/images/form/xing1.JPG"
                                                                     align="absmiddle"></td>
        </tr>
        <tr align="center">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <table class='page_form_table' width='530' align='center'
                                            ...
                                            <tr class='page_form_tr'>
                                                <td class=
                                                        "page_form_td" width='20%' align="left">合同确定用途<br>（最多300汉字）
                                                </td>
                                                <td class="page_form_td" width='80%'><textarea name="CMT1" <%=readonly%>
                                            ...
                                            <tr class='page_form_tr'>
                                                <td class='page_form_td' align="left">实际用途<br>（最多300汉字）</td>
                                                <td class="page_form_td" nowrap><textarea name="CMT2" <%=readonly%>
                                                                                          wrap="PHYSICAL" cols="55"
                                                                                          rows="3"
