...
public class PaybackAgreementPageAction extends FormActions {
    Param param = null;
    ...
    public int load(SessionContext ctx, DatabaseConnection conn, FormInstance instance, ErrorMessages msgs,
        ...
        if (ctx.getParameter("SEQNO") != null) {
            instance.setValue("SEQNO",Integer.parseInt(ctx.getParameter("SEQNO").trim()));
    ...
    public int preInsert(SessionContext ctx, DatabaseConnection conn,
        ...
        int seqNo = (int) SerialNumber.getNextSN("BMILPAYBACKAGREEMENT", "SEQNO");
