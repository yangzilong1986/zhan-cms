...
<%--
=============================================== 
Title: 查询自然人其他和微型企业分类信息列表
Description: 查询自然人其他和微型企业分类分类信息列表。
...
<%
	...
	String s_count="select fcno from upzrrqt  kh";	
	String s_main="select * from(select rownumber() over(order by kh.isempty desc) AS rn,kh.*,enum1.enudt as daikfs_lk,enum2.enudt as fleijg_lk,enum3.enudt as daikzl_lk from upzrrqt kh ";
	...
	sql+=" left join UPENUMINFODETL enum3 on kh.daikzl=enum3.enutp and enum3.enuid='daikzl3'";
...
<html>
	...
	<form id="winform" method="post" action="/fc/upzrrqt_list.jsp">
					...
					<table  border="2" align="center" cellpadding="2"
						...
						<tr align="left">
							<td height="30" bgcolor="#4477AA" colspan=2>
								...
								<font size="2" color="#FFFFFF"><b>自然人其他和微型企业分类信息查询</b>
								</font>
								<img src="images/form/xing1.jpg" align="absmiddle">
							</td>
						</tr>
													...
													<%if (crs!=null){ %>
														<table class='list_form_table' width='100%' align='center' cellpadding='0' cellspacing='1' border='0'>
															<tr class='list_form_title_tr'>
																...
																<td  class='list_form_title_td' nowrap>合同号</td>
															...
															if (crs.getString("isempty")==null) 
															   ...
															   color="#ffffff";
															%>
															<tr bgcolor="<%=color%>" onmouseover="mOvr(this)" onclick="mClk('/fc/upzrrqt_detail.jsp?fcno=<%=crs.getString("fcno") %>');" onmouseout="mOut(this,'<%=color%>');">
							...
							<td align="center">
								<table border="0" cellspacing="0" cellpadding="0" width="538">
									<tr>
										...
										<script language="javascript">
									createFlipPage(<%=pn%>,<%=ps%>,<%=rows%>,"/fc/upzrrqt_list.jsp?pn=","winform");
									</script>
									</tr>
								</table>
							</td>
