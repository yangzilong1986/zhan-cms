...
<%--
=============================================== 
Title: 查询自然人一般贷款和消费类贷款分类信息列表
Description: 查询自然人一般贷款和消费类贷款分类信息列表
 * @version  $Revision: 1.6 $  $Date: 2007/05/31 07:22:37 $
 * @author   weiyb
 * <p/>修改：$Author: weiyb $
=============================================== 
--%>
<%
	...
	String s_count="select fcno from upzrrnh  kh";	
	String s_main="select * from(select rownumber() over(order by kh.isempty desc) AS rn,kh.*,enum1.enudt as daikfs_lk,enum2.enudt as fleijg_lk,enum3.enudt as daikzl_lk from upzrrnh kh ";
	String s_where=" where 1=1 ";
	//s_where+=" and kh.jrjgdm like '"+jgdm+"%'";
	if (clientname!=null&&!clientname.equals(""))
		s_where+=" and kh.kehumc like '%"+clientname.trim()+"%'";
	if (enddate!=null&&!enddate.equals(""))
		s_where+=" and kh.fljzrq='"+enddate.trim()+"'";
	s_where+=" and kh.brhid in "+brhlist+" and kh.fleijg in ('1','2')";		
	String sql=" left join UPENUMINFODETL enum1 on kh.daikfs=enum1.enutp and enum1.enuid='daikfs'";
	sql+=" left join UPENUMINFODETL enum2 on kh.fleijg=enum2.enutp and enum2.enuid='fleijg'";
	sql+=" left join UPENUMINFODETL enum3 on kh.daikzl=enum3.enutp and enum3.enuid='daikzl2'";
...
<html>
	...
	<form id="winform" method="post" action="/fc/upzrrnh_list.jsp">
					...
					<table  border="2" align="center" cellpadding="2"
						...
						<tr align="left">
							<td height="30" bgcolor="#4477AA" colspan=2>
								...
								<font size="2" color="#FFFFFF"><b>自然人一般贷款和消费类贷款分类信息查询</b>
								</font>
								<img src="images/form/xing1.jpg" align="absmiddle">
							</td>
						</tr>
													...
													<td>
														...
														<table class='list_form_table' width='100%' align='center'
															...
															<tr class='list_form_title_tr'>
															   <td  class='list_form_title_td' nowrap>客户号</td>
																<td  class='list_form_title_td' nowrap>借款人</td>
																<td  class='list_form_title_td' nowrap>贷款合同代码</td>
																<td  class='list_form_title_td' nowrap>贷款合同金额</td>
																<td  class='list_form_title_td' nowrap>合同生效日期</td>
																<td  class='list_form_title_td' nowrap>合同终止日期</td>
																
																<td  class='list_form_title_td' nowrap>贷款方式</td>
																<td  class='list_form_title_td' nowrap>贷款余额</td>
																<td  class='list_form_title_td' nowrap>分类结果</td>
																<td  class='list_form_title_td' nowrap>贷款种类</td>
																<!--  
																<td  class='list_form_title_td' nowrap>违约期数</td>
																<td  class='list_form_title_td' nowrap>利息逾期天数</td>
																-->
															</tr>
															<%
															String color="";
															...
															if (crs.getString("isempty")==null) 
															   ...
															   color="#ffffff";
															%>
															<tr  bgcolor="<%=color %>" onmouseover="mOvr(this)" onclick="mClk('/fc/upzrrnh_detail.jsp?fcno=<%=crs.getString("fcno") %>');" onmouseout="mOut(this,'<%=color %>');">
																<td class='list_form_td' align="center">
																	<%=DBUtil.fromDB2(crs.getString("khh"))%>
																</td>
																<td class='list_form_td' align="right">
																	<%=DBUtil.fromDB2(crs.getString("kehumc"))%>
																</td>
																<td class='list_form_td' align="center">
																...
																<td class='list_form_td' align="center">
																	<%=DBUtil.fromDB2(crs.getString("htsxrq"))%>
																</td>
																<td class='list_form_td' align="center">
																	<%=DBUtil.fromDB2(crs.getString("htzzrq"))%>
																</td>
																<td class='list_form_td' align="center">
																	<%=DBUtil.fromDB2(crs.getString("daikfs_lk"))%>
																</td>
																<td class='list_form_td' align="right">
																...
																<td class='list_form_td' align="center">
																	<%=DBUtil.fromDB2(crs.getString("daikzl_lk"))%>
																</td>
																<!--  
																<td class='list_form_td' align="right">
																	<%=DBUtil.fromDB2(crs.getString("weiyqs"))%>
																</td>
																<td class='list_form_td' align="right">
																	<%=DBUtil.fromDB2(crs.getString("lxyqts"))%>
																</td>
																-->
															</tr>
															<%} %>
							...
							<td align="center">
								<table border="0" cellspacing="0" cellpadding="0" width="538">
									<tr>
										...
										<script language="javascript">
									createFlipPage(<%=pn%>,<%=ps%>,<%=rows%>,"/fc/upzrrnh_list.jsp?pn=","winform");
									</script>
									</tr>
								</table>
							</td>
