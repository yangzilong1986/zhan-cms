...
String sql="select * from FCMCMT where FCNO='"+FCNO+"' and FCCMTTYPE=7";
...
function newAffair(affairName){
	var flag=0;
	if(affairName=='add'){
		var url="z_cwzk_add.jsp?FCNO=<%=FCNO%>&FCSTATUS=<%=FCSTATUS%>";
...
function info(FCNO,DT,FCSTATUS){
		var url='z_cwzk_info.jsp?FCNO='+FCNO+'&DT='+DT+'&FCSTATUS='+FCSTATUS;
  ...
  <tr>
    <td align="center" valign="middle">
      <table height="325" border="2" align="center" cellpadding="2" cellspacing="2" bordercolor="#006699" bgcolor="AACCEE" >
        <tr align="left">
          <td height="30" bgcolor="#4477AA"> <img src="/images/form/xing1.jpg" align="absmiddle"> <font size="2" color="#FFFFFF"><b>财务状况</b></font> <img src="/images/form/xing1.jpg" align="absmiddle"></td>
        </tr>
        <tr align="center">
                        ...
                        <table class='list_form_table' width='530' align='center' cellpadding='0' cellspacing='1' border='0'>
                            <tr class='list_form_title_tr'>
							 <td   nowrap width="5%" align="center"><input name="f02" type='checkbox' id="f02" onClick="checkSub('f02','form1','elements')" value="1"></td>
                              ...
                              <td width='15%' class='list_form_title_td' nowrap align="center">资产总额</td>
							  <td width='15%' class='list_form_title_td' nowrap align="center">负债总额</td>
							  <td width='15%' class='list_form_title_td' nowrap align="center">经营收入</td>
							  <td width='15%' class='list_form_title_td' nowrap align="center">预计年净收益</td>
...
%>
							...
							<td align='center' nowrap><input name="DT" type='checkbox' id="f020<%=j++%>" value="<%=crs.getString("DT")%>"></td>
							  ...
							  <td nowrap class='list_form_td' align="right"><%=crs.getBigDecimal("AMT5")==null?"":df.format(crs.getBigDecimal("AMT5"))%></td>
							  <td nowrap class='list_form_td' align="right"><%=crs.getBigDecimal("AMT8")==null?"":df.format(crs.getBigDecimal("AMT8"))%></td>
              ...
              <tr>
                <td nowrap align="left">
                  ...
                  <table class='list_button_tbl'>
    				...
    				createFlipPage(<%=pn%>,<%=ps%>,<%=rows%>,"z_cwzk.jsp?pn=","form1");
					</script>
                    </tr>
                </table></td>
              </tr>
...
function req(){
	document.location.replace("/fcworkbench/z_cwzk/z_cwzk.jsp");
}
</script>
