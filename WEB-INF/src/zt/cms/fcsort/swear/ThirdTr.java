...
public class ThirdTr {
	...
	public String getBrhidname() {
		return DBUtil.fromDB(brhidname);
	}
	public void setBrhidname(String brhidname) {
		this.brhidname = brhidname;
	}
