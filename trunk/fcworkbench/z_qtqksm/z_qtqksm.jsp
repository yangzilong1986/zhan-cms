...
String sql="select * from FCMCMT where FCNO='"+FCNO+"' and FCCMTTYPE=9";
...
function newAffair(affairName){
	var flag=0;
	if(affairName=='add'){
		var url="z_qtqksm_add.jsp?FCNO=<%=FCNO%>&FCSTATUS=<%=FCSTATUS%>";
...
function info(FCNO,DT,FCSTATUS){
		var url='z_qtqksm_info.jsp?FCNO='+FCNO+'&DT='+DT+'&FCSTATUS='+FCSTATUS;
  ...
  <tr>
    <td align="center" valign="middle">
      <table height="325" border="2" align="center" cellpadding="2" cellspacing="2" bordercolor="#006699" bgcolor="AACCEE" >
        <tr align="left">
          <td height="30" bgcolor="#4477AA"> <img src="/images/form/xing1.jpg" align="absmiddle"> <font size="2" color="#FFFFFF"><b>其他情况说明</b></font> <img src="/images/form/xing1.jpg" align="absmiddle"></td>
        </tr>
        <tr align="center">
                        ...
                        <table class='list_form_table' width='530' align='center' cellpadding='0' cellspacing='1' border='0'>
                            <tr class='list_form_title_tr'>
							 <td   nowrap width="6%" align="center"><input name="f02" type='checkbox' id="f02" onClick="checkSub('f02','form1','elements')" value="1"></td>
                              <td width='19%' class='list_form_title_td' nowrap align="center">调查日期</td>
                              <td width='65%' class='list_form_title_td' nowrap align="center">其他情况说明</td>
							  <td width='19%' class='list_form_title_td' nowrap align="center">详细</td>
							  </tr>
                            <%
int j=0;
...
%>
							...
							<td align='center' nowrap><input name="DT" type='checkbox' id="f020<%=j++%>" value="<%=crs.getString("DT")%>"></td>
							  ...
							  <td nowrap class='list_form_td' align="left"><%=crs.getString("CMT1")==null?"":DBUtil.fromDB(crs.getString("CMT1").length()>60?crs.getString("CMT1").substring(0,60)+"...":crs.getString("CMT1"))%></td>
              ...
              <tr>
                <td nowrap align="left">
                  ...
                  <table class='list_button_tbl'>
    				...
    				createFlipPage(<%=pn%>,<%=ps%>,<%=rows%>,"z_qtqksm.jsp?pn=","form1");
					</script>
                    </tr>
                </table></td>
              </tr>
...
function req(){
	document.location.replace("/fcworkbench/z_qtqksm/z_qtqksm.jsp");
}
</script>
