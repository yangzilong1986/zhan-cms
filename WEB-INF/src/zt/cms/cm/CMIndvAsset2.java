...
public class CMIndvAsset2
    extends FormActions {

  public static Logger logger = Logger.getLogger("zt.cms.cm.CMIndvAsset2");
  ...
  public int preFind(SessionContext ctx, DatabaseConnection conn,
      ...
      String value = ClientSum.getClientSumWithUnit(CLIENTNO,"CMINDVASSET","estimate",conn,"estimateunit");
      ctx.setAfterBody("estimate="+value+"");
