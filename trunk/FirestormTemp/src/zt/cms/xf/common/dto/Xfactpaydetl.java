...
public class Xfactpaydetl implements Serializable
{
	...
	/** 
	 * This attribute maps to the column RECVNAME in the XFACTPAYDETL table.
	 */
	protected String recvname;

	/** 
	 * This attribute maps to the column ACCOUNTDATE in the XFACTPAYDETL table.
	 */
	protected Date accountdate;

	/** 
	 * This attribute maps to the column LOG in the XFACTPAYDETL table.
	 */
	...
	public boolean equals(Object _other)
	{
		...
		if (recvname == null ? _cast.recvname != recvname : !recvname.equals( _cast.recvname )) {
			return false;
		}
		
		if (accountdate == null ? _cast.accountdate != accountdate : !accountdate.equals( _cast.accountdate )) {
			return false;
		}
	...
	public int hashCode()
	{
		...
		if (recvname != null) {
			_hashCode = 29 * _hashCode + recvname.hashCode();
		}
		
		if (accountdate != null) {
			_hashCode = 29 * _hashCode + accountdate.hashCode();
		}
	...
	public String toString()
	{
		...
		ret.append( ", recvname=" + recvname );
		ret.append( ", accountdate=" + accountdate );
		ret.append( ", log=" + log );
		return ret.toString();
	}
