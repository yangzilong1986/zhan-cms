					...
					<td class='error_message_tbl_td'><%=mess%></td>
                      ...
                      <table class='page_form_table' id='page_form_table' width="300" height="20">
						...
						<tr class='page_form_tr'>
                          ...
                          <td class="page_form_td" nowrap><%=FC1==null?"":FCSTATUS.equals("1")?level.levelHere("FC1","LoanCat1",FC1):level.levelHere1("FC1","LoanCat1",FC1)%></td>
                        </tr>
						<tr class='page_form_tr'>
                          ...
                          <td class="page_form_td" nowrap><%=FC2==null?"":level.levelHere1("FC2","LoanCat1",FC2)%></td>
                        </tr>
						<tr class='page_form_tr'>
						...
						<input type="button" name="CorpPayables" value="历史清分信息"  class="page_form_button_active" onClick="newAffair(this.name);">
...
function newAffair(affairName){
	var flag=0;
		var url="history_qf.jsp?BMNO=<%=BMNO%>";
