...
String sql="select * from FCMCMT where FCNO='"+FCNO+"' and FCCMTTYPE=4";
...
function newAffair(affairName){
	var flag=0;
	if(affairName=='add'){
		var url="z_dbqk_add.jsp?FCNO=<%=FCNO%>&FCSTATUS=<%=FCSTATUS%>";
...
function info(FCNO,DT,FCSTATUS){
		var url='z_dbqk_info.jsp?FCNO='+FCNO+'&DT='+DT+'&FCSTATUS='+FCSTATUS;
  ...
  <tr>
    <td align="center" valign="middle">
      <table height="325" border="2" align="center" cellpadding="2" cellspacing="2" bordercolor="#006699" bgcolor="AACCEE" >
        <tr align="left">
          <td height="30" bgcolor="#4477AA"> <img src="/images/form/xing1.jpg" align="absmiddle"> <font size="2" color="#FFFFFF"><b>担保情况</b></font> <img src="/images/form/xing1.jpg" align="absmiddle"></td>
        </tr>
        <tr align="center">
                        ...
                        <table class='list_form_table' width='530' align='center' cellpadding='0' cellspacing='1' border='0'>
                            <tr class='list_form_title_tr'>
							 <td   nowrap width="5%" align="center"><input name="f02" type='checkbox' id="f02" onClick="checkSub('f02','form1','elements')" value="1"></td>
                              ...
                              <td width='15%' class='list_form_title_td' nowrap align="center">担保合同是否有效</td>
							  <td width='15%' class='list_form_title_td' nowrap align="center">保证人代偿能力</td>
							  <td width='15%' class='list_form_title_td' nowrap align="center">抵质押物及其价值</td>
							  <td width='15%' class='list_form_title_td' nowrap align="center">抵质押物的变现能力</td>
              ...
              <tr>
                <td nowrap align="left">
                  ...
                  <table class='list_button_tbl'>
    				...
    				createFlipPage(<%=pn%>,<%=ps%>,<%=rows%>,"z_dbqk.jsp?pn=","form1");
					</script>
                    </tr>
                </table></td>
              </tr>
...
function req(){
	document.location.replace("/fcworkbench/z_dbqk/z_dbqk.jsp");
}
</script>
