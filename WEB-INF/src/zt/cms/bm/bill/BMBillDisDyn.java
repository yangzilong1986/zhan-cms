 ...
 *  $Id: BMBillDisDyn.java,v 1.2 2005/07/14 08:12:58 jgo Exp $
 */
...
public class BMBillDisDyn
                    ...
                    EventManager manager, String parameter)
    {
        ...
        if (bmroute.hasRightToAct(Integer.parseInt(strUserId), EnumValue.BMType_TieXian,
...
//        ctx.setRequestAtrribute("flag", strFlag);
        ...
        if(col != null && col.compareToIgnoreCase("fc") == 0)
        {
          ...
          ctx.setTarget("/fcworkbench/createbilldisfcmain.jsp?confirmed=0&billno="+strbilldisno);
          return 0;
        }
