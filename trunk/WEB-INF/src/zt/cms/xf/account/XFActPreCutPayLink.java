 ...
 */
public class XFActPreCutPayLink extends FormActions {

    public static Logger logger = Logger.getLogger("zt.cms.xf.account.XFActPrePayLink");
    ...
    public int buttonEvent(SessionContext ctx, DatabaseConnection conn, FormInstance instance,
        ...
        if (button.equals("NEXT")) {
            ...
            try {
                ...
                if ((count = bm.generatePreCutPayBills(ctx, conn, msgs)) == 0) {
    ...
    private int countWaitChargeoffBills(ErrorMessages msgs) {
        ...
        try {
            ...
            String sql = "precutpaycd = '1' and ((chargeoffcd = '0' and to_char(paybackdate, 'yyyyMMdd') <= " + strDate + ")  or " +
                    "(chargeoffcd = '1' and  closedcd = '0' and to_char(paybackdate, 'yyyyMMdd') <= " + strDate + ")) ";
