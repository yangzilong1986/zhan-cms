...
<html>
	...
	<body background="/images/checks_02.jpg">
		<form action="<%=currentPath%>Rate_ZS.jsp" name="listfrom">
											...
											<div id='showTable' align=center width=100%>
												<div class=caption align=center>
													...
													<table class=table cellSpacing=1 cellPadding=1 width=100% border=0 align=center>
														<TBODY>
															  <tr class="head">
															    <td rowspan="2" align="center" valign="bottom" >网点</td>
															    <td colspan="2" align="center" valign="bottom">期初向下迁徙金额</td>
															    <td colspan="2" align="center" valign="bottom">期初贷款余额</td>
															    <td colspan="2" align="center" valign="bottom">期间减少额</td>
															    <td rowspan="2" align="center" valign="bottom">迁徙率</td>
															  </tr>
															  <tr class="head">
															    <td align="center" valign="bottom">正常</td>
															    <td align="center" valign="bottom">关注</td>
															    <td align="center" valign="bottom">正常</td>
															    <td align="center" valign="bottom">关注</td>
															    <td align="center" valign="bottom">正常</td>
															    <td align="center" valign="bottom">关注</td>
															  ...
															  <%
															  	...
															  	FirstTr tr = (FirstTr)list.get(i);
															  		...
															  		balgc+=tr.getBalgc();
															  		 ...
															  		 bale=(balzb+balgb-balgc-balzc)==0?1:(balzb+balgb-balgc-balzc);
															  		
															  		 rate=(balza+balga)/bale*100;
															  		%>
															  		  <tr class=data bgcolor=#FFFFFF onmouseout="mOut(this);" onmouseover="mOvr(this);" onclick=" tosecondlistZS('<%=tr.getBrhid().trim() %>');">
																	    <td ><%=tr.getBrhname() %></td>
																	    <td align="right"><%=df1.format(tr.getBalza()) %></td>
																	    <td align="right"><%=df1.format(tr.getBalga()) %></td>
																	    <td align="right"><%=df1.format(tr.getBalzb()) %></td>
																	    <td align="right"><%=df1.format(tr.getBalgb()) %></td>
																	    <td align="right"><%=df1.format(tr.getBalzc()) %></td>
																	    <td align="right"><%=df1.format(tr.getBalgc())%></td>
															  ...
															  <tr class="head">
															    	...
															    	<td align="right"><%=df1.format(balza) %></td>
															   		<td align="right"><%=df1.format(balga) %></td>
															    	<td align="right"><%=df1.format(balzb) %></td>
															    	<td align="right"><%=df1.format(balgb) %></td>
															   		<td align="right"><%=df1.format(balzc) %></td>
															    	<td align="right"><%=df1.format(balgc) %></td>
													...
													<table cellSpacing=0 cellPadding=0 width=100% border=0
														...
														<tr>
															...
															<td align=right>
																<input type="button" value="返回初始页" class="button" onclick="backStartListZS();">	&nbsp;
