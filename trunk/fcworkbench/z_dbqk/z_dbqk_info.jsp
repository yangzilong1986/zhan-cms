...
<%
    ...
    String sql = "select * from FCMCMT where FCNO='" + FCNO + "' and DT='" + DT + "' and FCCMTTYPE=4";
...
<form action="z_dbqk_info_save.jsp" name="form1" method="post" id="winform">
                        ...
                        <tr>
                            <td>
                                ...
                                <table class='page_form_table' width='400' align='center'
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>保证人代偿能力<br>（最多300汉字）
                                        </td>
                                        <td class="page_form_td" nowrap><textarea
                                                name="CMT2" <%=readonly%> wrap="PHYSICAL"
                                                cols="55" rows="3"
                                                class="page_form_text"><%=CMT2 == null ? "" : DBUtil.fromDB(CMT2)%>
                                        </textarea></td>
                                    </tr>
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>抵质押物及其价值<br>（最多300汉字）
                                        </td>
                                        <td class="page_form_td" nowrap><textarea
                                                name="CMT3" <%=readonly%> wrap="PHYSICAL"
                                                cols="55" rows="3"
                                                class="page_form_text"><%=CMT3 == null ? "" : DBUtil.fromDB(CMT3)%>
                                        </textarea></td>
                                    </tr>
                                    <tr class='page_form_tr'>
                                        <td class='page_form_td' align="left" nowrap>抵质押物的变现能力<br>（最多300汉字）
                                        </td>
                                        <td class="page_form_td" nowrap><textarea
                                                name="CMT4" <%=readonly%> wrap="PHYSICAL"
                                                cols="55" rows="3"
                                                class="page_form_text"><%=CMT4 == null ? "" : DBUtil.fromDB(CMT4)%>
                                        </textarea></td>
                                    </tr>
                                    <tr class='page_form_tr'>
                                        <td class="page_form_td" nowrap>&nbsp;</td>
