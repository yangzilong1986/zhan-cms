package zt.cms.xf.common.formutils;
...
/*
 修改弹出窗口大小 zhanrui 20090531
 */
public class NewEditFieldFormat extends FieldFormat implements Serializable{
    public String format(SessionContext ctx, ElementBean eb1, FormInstance fi, RecordSet values) {
        ...
        String body = "<div align=\"center\"><a class=\"list_edit_href\" href=\"#\" onclick=\"window.open('" +
                ...
                "','FI" + fi.getInstanceid() + "','left=0,top=0,height=480,width=980,toolbar=no,scrollbars=yes,resizable=yes');\">" + eb1.getCaption() +
                "</a></div>";
        return body;
    }
}