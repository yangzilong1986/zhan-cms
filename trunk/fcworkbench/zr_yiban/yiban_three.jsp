					...
					<td class='error_message_tbl_td'><%=mess%></td>
                      ...
                      <table class='page_form_table' id='page_form_table' width="300" height="20">
						...
						<tr class='page_form_tr'>
                          ...
                          <td class="page_form_td" nowrap><%=FCSTATUS.equals("3")?FC2!=null?level.levelHere("FC3","LoanCat1",FC2):level.levelHere1("FC3","LoanCat1",FC3):level.levelHere1("FC3","LoanCat1",FC3)%></td>
                        </tr>
						<tr class='page_form_tr'>
