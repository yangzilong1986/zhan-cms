...
calls to this DAO, otherwise a new Connection will be allocated for each operation.
	 ...
	 */
	protected final String SQL_SELECT = "SELECT SEQNO, XDKHZD_KHBH, XDKHZD_KHMC, GTHTJH_HTBH, GTHTJH_DATE, GTHTJH_LL, GTHTJH_JHJE, GTHTJH_BJJE, GTHTJH_LXJE, GTHTB_ZHBH, BILLSTATUS, CREATETIME, CUTPAYACTNO, FAILREASON, REMARK, PREFLAG, GTHTJH_HTNM, GTHTJH_JHXH, JOURNALNO, REGIONCD, BANKCD FROM " + getTableName() + "";
	 ...
	 */
	protected final String SQL_INSERT = "INSERT INTO " + getTableName() + " ( SEQNO, XDKHZD_KHBH, XDKHZD_KHMC, GTHTJH_HTBH, GTHTJH_DATE, GTHTJH_LL, GTHTJH_JHJE, GTHTJH_BJJE, GTHTJH_LXJE, GTHTB_ZHBH, BILLSTATUS, CREATETIME, CUTPAYACTNO, FAILREASON, REMARK, PREFLAG, GTHTJH_HTNM, GTHTJH_JHXH, JOURNALNO, REGIONCD, BANKCD ) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";

	/** 
	 * SQL UPDATE statement for this table
	 */
	protected final String SQL_UPDATE = "UPDATE " + getTableName() + " SET SEQNO = ?, XDKHZD_KHBH = ?, XDKHZD_KHMC = ?, GTHTJH_HTBH = ?, GTHTJH_DATE = ?, GTHTJH_LL = ?, GTHTJH_JHJE = ?, GTHTJH_BJJE = ?, GTHTJH_LXJE = ?, GTHTB_ZHBH = ?, BILLSTATUS = ?, CREATETIME = ?, CUTPAYACTNO = ?, FAILREASON = ?, REMARK = ?, PREFLAG = ?, GTHTJH_HTNM = ?, GTHTJH_JHXH = ?, JOURNALNO = ?, REGIONCD = ?, BANKCD = ? WHERE SEQNO = ?";
