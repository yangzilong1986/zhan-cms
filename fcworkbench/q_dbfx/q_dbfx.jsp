...
<%
    ...
    String CMT1 = "";
//String CMT2="";
    String sql = "select * from FCCMT where FCNO='" + FCNO + "' and FCCMTTYPE=6";
...
<form action="q_dbfx_save.jsp" name="form1" method="post" onsubmit="return Regvalid(this)">
            ...
            <table height="325" border="2" align="center" cellpadding="2" cellspacing="2" bordercolor="#006699"
                ...
                <tr align="left">
                    <td height="30" bgcolor="#4477AA"><img src="/images/form/xing1.JPG" align="absmiddle"> <font
                            size="2" color="#FFFFFF"><b>担保分析</b></font> <img src="/images/form/xing1.JPG"
                                                                             align="absmiddle"></td>
                </tr>
                <tr align="center">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <table class='page_form_table' width='530' align='center'
                                                    ...
                                                    <tr class='page_form_tr'>
                                                        <td class=
                                                                "page_form_td" width='15%' align="left">担保分析<br>（最多300汉字）
                                                        </td>
