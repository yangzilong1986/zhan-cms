...
<%
	...
	if(!scbrhtype.trim().equals("9"))
	{
		...
		firstresp="第一责任人："+sd.getCLIENTMGR("FIRSTRESP","FIRSTRESP",vp.getFirstresp(),vp.getBrhid());
	}
	String selectYM = "<input type=\"hidden\" id=\"stype\" name=\"stype\" value=\"\">";//vp.getQueryid().endsWith("FCBMAIN")?"":sd.selectType("stype","stype",vp.getStype());
	String  listTH = "网点名称,借款人名称,贷款用途,合同金额,结欠金额,期限,利率,发放日,到期日,四级形态,五级分类,第一责任人,"+vp.getThirlasttr();
	...
	String[] titles= new String[]{vp.getTitle()+"三级","单位名称："+vp.getScbrhname(),vp.getMTitle(),"单位：元"};
...
<%--
=============================================== 
Title:五级分类不良资产台帐查询二级页面
 * @version  $Revision: 1.11 $  $Date: 2007/05/31 03:13:56 $
 * @author   zhengxin
 * <p/>修改：$Author: zhengx $ 
=============================================== 
--%>
...
<html>
	...
	<body background="/images/checks_02.jpg">
		<form action="<%=currentPath%>thirdList.jsp" name="listfrom">
												...
												<table width=100% border=0 align="center" cellPadding=0
													...
													<TR>
														...
														<!-- 保存页面参数 -->
															...
															<input type="hidden" id="sqlpartname" name="sqlpartname" value="<%=vp.getSqlpartname() %>">
															<input type="hidden" id="sqlpartvalue" name="sqlpartvalue" value="<%=vp.getSqlpartvalue() %>">
															&nbsp;&nbsp;&nbsp;&nbsp;
														...
														<br>
															<table class="table" cellSpacing=1 cellPadding=1 width=100% border=0>
															  ...
															  贷款发放日：
															     ...
															     <input name="button" type='button' class='button'onclick='setday(this,document.getElementById(&quot;startdate&quot;))' value='…' />
																至
																<input class='input' type="text" id="enddate" name="enddate"size="10" value="<%=vp.getEnddate() %>" />
																<input name="button" type='button' class='button'onclick='setday(this,document.getElementById(&quot;enddate&quot;))' value='…' /></td>
															  </tr>
															  <tr class=head>
															    <td>&nbsp;</td>
															    <td width="40%">单笔贷款余额：
												...
												<div class=caption align=center>
													...
													<table cellSpacing=0 cellPadding=0 width=100% border=0
														...
														<tr>
															...
															<input type="button" value="返回上级" class="button" onclick=" backSecondlist();">&nbsp;
