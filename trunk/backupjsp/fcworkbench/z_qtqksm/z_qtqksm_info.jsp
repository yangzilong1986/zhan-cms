...
<form action="z_qtqksm_info_save.jsp" name="form1" method="post" id="winform">
...
<tr align="left">
    <td height="30" bgcolor="#4477AA"><img src="/images/form/xing1.JPG" align="absmiddle"> <font
            size="2" color="#FFFFFF"><b>其他情况说明</b></font> <img src="/images/form/xing1.JPG"
                                                               align="absmiddle"></td>
</tr>
<tr align="center">
                        ...
                        <tr>
                            <td>
                                ...
                                <table class='page_form_table' width='400' align='center'
                                    ...
                                    <tr class='page_form_tr'>
                                        <td class="page_form_td" align="left" nowrap>其他情况说明<br>（最多300汉字）
                                        </td>
                    ...
                    <table class='list_button_tbl'>
                        <tr class="list_button_tbl_tr">
                            <td class="list_form_button_td"><input type='button'
                                                                   ...
                                                                   id='savebtn'
                                                                   name='save' value=' 提 交 '
                                                                   onclick='return Regvalid()' <%=submit%> >
                            </td>
...
<script language="javascript" type="text/javascript">
    ...
    function user_check() {
        this.opener.location = "/fcworkbench/z_qtqksm/z_qtqksm.jsp?pn=" + this.opener.document.all.pnstr.value + "" +
                               "&FCNO=<%=FCNO%>" +
                               "&FCSTATUS=<%=FCSTATUS%>";
        this.close();
    }
