...
public class BmCreditChgPwd
  ...
  public int buttonEvent(SessionContext ctx, DatabaseConnection conn,
    ...
    try {
      ...
      String oldpwd = ctx.getParameter("OLDPWD").trim();
      ...
      if (password.compareToIgnoreCase(new String(ed.enPasswd(oldpwd.getBytes()))) ==
          0) {
