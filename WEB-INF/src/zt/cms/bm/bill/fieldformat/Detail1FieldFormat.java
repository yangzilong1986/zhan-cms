...
public class Detail1FieldFormat extends FieldFormat
{
...
//        } else {
        String body = "<a class=\"list_edit_href\" href=\"#\" onclick=\"window.open('"
            +   ctx.getUrl(actionurl) + "?" + value +"&ACTNO="+values.getString("ACTNO") +
            "&CNLNO="+values.getString("CNLNO").trim() +
                "','FI"+fi.getInstanceid()+"','height=600,width=800,toolbar=no,scrollbars=yes,resizable=yes');\">" + "详细" +
                "</a>";
